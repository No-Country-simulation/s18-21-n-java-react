  ...
  return (
    <form className="w-full" onSubmit={onSubmit}>
      <div className="flex gap-6 justify-between">
        <FormItem>
          <Label className="block pt-4 pb-1">Nombre del Producto</Label>
        ...
        <FormItem>
          <Label className="block pt-4 pb-1">Precio</Label>
      ...
      <FormItem>
        <Label className="block pt-4 pb-1">Descripción corta</Label>
        <Input
          className="block"
          type="text"
      ...
      <FormItem>
        <Label className="block pt-4 pb-1">Descripción</Label>
        <Textarea
      ...
      <div className="flex gap-6 justify-between">
        <FormItem>
          <Label className="block pt-4 pb-1">Imagen</Label>
          <Input className="block" type="file" {...register("photo")} />
          {typeof errors.photo?.message === "string" && (
            <p className="text-xs text-red-700">{errors.photo.message}</p>
          )}
        </FormItem>
        <FormItem>
          <Label className="block pt-4 pb-1">Categoria</Label>
      ...
      <div className="flex gap-6 justify-between">
        <FormItem>
          <Label className="block pt-4 pb-1">Stock</Label>
          <Input className="block" type="text" {...register("stock")} />
          {errors.stock?.message && (
            <p className="text-xs text-red-700">{errors.stock?.message}</p>
          )}
        </FormItem>
        <FormItem>
          <Label className="block pt-4 pb-1">Marca</Label>
          <Input className="block" type="text" {...register("brand")} />
          {errors.brand?.message && (
            <p className="text-xs text-red-700">{errors.brand?.message}</p>
          )}
        </FormItem>
      </div>
